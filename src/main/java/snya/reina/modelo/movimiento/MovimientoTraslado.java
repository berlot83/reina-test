...
@Audited
public class MovimientoTraslado extends Movimiento {
	...
	public MovimientoTraslado(){
		
	}

	public MovimientoTraslado(Intervencion intervencion, Date fecha, TipoDeMovimiento tipo,
	...
	public ResultadoPresente asentarHistorial(Joven joven, Intervencion intervencion, ProcesoPenal proceso, AmbitoEjecucion ambitoEjecucionOrigen, AmbitoEjecucion ambitoEjecucionDestino, EscritorNarrativoDeHistoria escritor) {
		...
		presenteAnterior.asentarCierrePorTraslado(this, proceso, medida, ambitoEjecucionDestino, escritor);
				
		// Apertura		
		Permanencia presente = new Permanencia(intervencion, joven, this.getFecha(), ambitoEjecucionDestino, proceso, medida);
		presente.asentarMovimientoTraslado(this, this.getMotivo(), proceso, escritor);
	...
	public void modificarHistorial(Joven joven, EscritorNarrativoDeHistoria escritor){
		if (this.getEstado().estaConfirmado()) {
			...
			if(presenteAnterior != null) {
				...
				presenteAnterior.quitarTraslado(this, escritor);
			}
		}
	}
	...
	public void eventoConfirmar(ManejoEventoMovimiento manejo) {
		manejo.eventoConfirmarTraslado(this);
	}
}
